...
struct IChannelControl::RadioEntry {
    ...
    double txPower; // XXX ADDED BY ME
...
class INET_API ChannelControl : public cSimpleModule, public IChannelControl
{
  ...
  protected:
    ...
    /** XXX ADDED BY ME Calculate individual interference distance*/
    virtual double calcInterfDist(RadioRef h);
  ...
  public:
    ...
    /** XXX ADDED BY ME Called when host switches transmit power */
    virtual void setRadioTXPower(RadioRef r, double power);
    ...
    virtual double getInterferenceRange(RadioRef r);
