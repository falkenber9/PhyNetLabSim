...
const unsigned char  aMaxFrameRetries = 3; // max # of retries allowed after a transmission failures // XXX use value from MacPIB ?!?!
...
// ------------------------------------------ //
const unsigned char  aMaxBE = 5; // max value of the backoff exponent in the CSMA-CA algorithm // XXX use value from MacPIB ?!?!
